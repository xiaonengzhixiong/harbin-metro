...
export class UIController {
  ...
  getDocContent() {
    return `
      ...
      <p>取点并完成地铁拓扑图画布耗时约1.5小时。拓扑图取点来自于微信小程序MetroMan绘制的哈尔滨地铁线路图。起初想要使用地理线路图，但是画出的效果并不好，线路较为扭曲，因此放弃。</p>
      <p>编排UI耗时约1.5小时。其中最耗费时间的画面右上角的大时钟。该大时钟可以点击输入时间，导入字体、调整大小、调整早晚高峰时的时钟呼吸灯高亮均耗费了一番心思。</p>
      <p>敲代码实现列车在线路上运营耗时约5小时。其中1小时在调整1、2号线的发车逻辑，其余4小时一直在弄3号线。（请允许我用一大段文字为您描述一下当前哈尔滨地铁3号线的运营逻辑：运营时间开始，由于车库在汽轮机厂和进乡街站中间，因此内环列车，即顺时针列车需要从进乡街站发车；外环列车，即逆时针列车需要从汽轮机厂站发车，以8分钟一班的间隔从车库发车，所有列车绕环线一圈一圈地运营。早晚高峰开始时，需要增大列车密度，应对大客流，因此每隔一班车再加开一班车，结束后从对应的回库站点回库。这样的逻辑在全国环线地铁中算是最为简单的一批，我还对其中的一些技术难点进行了部分简化）另外，将鼠标靠近代表列车的圆点可以显示列车运营方向和所在区间。</p>
